export type CatalogEntry = {
  ...
  license_note: string;
  hf_repo: string;
  /** e.g. `tinyllama_v1`, `llama3_instruct`, `mistral_instruct`, `mistral3_instruct`, `qwen2_instruct`, `qwen2_instruct_reasoning`, `gemma2_it`, `gemma4_it`, `moonshot_instruct`, `phi4_instruct`, `hunyuan_dense`; bundled catalog supplies this; omitting defaults to Rust `tinyllama_v1`. */
