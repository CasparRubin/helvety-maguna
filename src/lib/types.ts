...
/** Matches Rust `ModelThinkingSettingsDto` — when enabled (`Thinking is on`), allows CoT prose for Qwen / Gemma 4 / GLM-4.7 Flash (DeepSeek-R1 / GLM-Z1 always reason; control markup always stripped in the UI). */
